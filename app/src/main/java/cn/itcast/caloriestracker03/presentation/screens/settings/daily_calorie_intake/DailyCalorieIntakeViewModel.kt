...
class DailyCalorieIntakeViewModel(
...
class DailyCalorieIntakeViewModelFactory(
    private val calorieCounterRepository: CaloriesCounterRepositoryImpl,
    private val userRepository: UserRepositoryImpl,
): ViewModelProvider.Factory{
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(DailyCalorieIntakeViewModel::class.java)){
            @Suppress("UNCHECKED_CAST")
            return DailyCalorieIntakeViewModel(
